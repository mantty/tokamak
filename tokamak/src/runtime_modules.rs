...
const PUBLIC_MODULES: &[(&str, &str)] = &[
    ...
    ("node:assert/strict", "tokamak:node/assert.mjs"),
    ...
    (
        "node:_http_agent",
        "tokamak:node/internal-http-agent.mjs",
    ),
    (
        "node:_http_client",
        "tokamak:node/internal-http-client.mjs",
    ),
    (
        "node:_http_common",
        "tokamak:node/internal-http-common.mjs",
    ),
    (
        "node:_http_incoming",
    ...
    (
        "node:_http_server",
        "tokamak:node/internal-http-server.mjs",
    ),
    ...
    ("node:path/posix", "tokamak:node/path.mjs"),
    ("node:path/win32", "tokamak:node/path.mjs"),
